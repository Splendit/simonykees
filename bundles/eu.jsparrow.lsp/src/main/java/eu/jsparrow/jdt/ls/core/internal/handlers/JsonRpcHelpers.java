...
final public class JsonRpcHelpers {
	...
	public static IDocument toDocument(IBuffer buffer) {
		...
		} else if (buffer instanceof eu.jsparrow.jdt.ls.core.internal.DocumentAdapter) {
			IDocument document = ((eu.jsparrow.jdt.ls.core.internal.DocumentAdapter) buffer).getDocument();
			if (document != null) {
				return document;
			}
		}
