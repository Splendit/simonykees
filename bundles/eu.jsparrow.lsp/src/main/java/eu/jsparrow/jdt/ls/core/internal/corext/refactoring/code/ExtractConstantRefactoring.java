 ...
 *******************************************************************************/
package eu.jsparrow.jdt.ls.core.internal.corext.refactoring.code;
...
import eu.jsparrow.jdt.ls.core.internal.corext.SourceRangeFactory;
import eu.jsparrow.jdt.ls.core.internal.corext.refactoring.RefactoringCoreMessages;
import eu.jsparrow.jdt.ls.core.internal.corrections.ASTResolving;
import eu.jsparrow.jdt.ls.core.internal.text.correction.ModifierCorrectionSubProcessor;
...
public class ExtractConstantRefactoring extends Refactoring {
	...
	/**
	 * Returns the type to which the new constant will be added to. It is the first
