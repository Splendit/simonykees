 ...
 * parameter. Requires the names of the local variables to be provided.
 * Distinguishes between the local variables and the fields with the same name.
 * 
 * @author Ardit Ymeri
 * @since 1.2
 *
...
class FieldReferencesVisitor extends ASTVisitor {
	...
	public FieldReferencesVisitor(SimpleName targetNode, ITypeBinding parentTypeBinding, ITypeBinding targetTypeBinding,
			List<String> declaredLocalVarNames) {
