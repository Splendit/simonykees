 ...
 * {@link EnhancedForLoopToStreamSumASTVisitor}.
 * 
 * @since 4.7.0
 *
 */
public class EnhancedForLoopToStreamSumResolver extends EnhancedForLoopToStreamSumASTVisitor implements Resolver {

	public static final String ID = "EnhancedForLoopToStreamSumResolver"; //$NON-NLS-1$

	private Predicate<ASTNode> positionChecker;
	private RuleDescription description;

	public EnhancedForLoopToStreamSumResolver(Predicate<ASTNode> positionChecker) {
		this.positionChecker = positionChecker;
		this.description = RuleDescriptionFactory
			.findByRuleId(EnhancedForLoopToStreamSumRule.RULE_ID);
	}
