...
class TransformationDataUsingBufferedWriterConstructor {
	...
	static Optional<TransformationDataUsingBufferedWriterConstructor> findTransformationData(
			ExpressionStatement writeInvocationStatementToReplace, Expression charSequenceArgument,
	...
	private static Optional<TransformationDataUsingBufferedWriterConstructor> findTransformationDataUsingWriterInstanceCreation(
			ExpressionStatement writeInvocationStatementToReplace, Expression charSequenceArgument,
			TryResourceAnalyzer bufferedWriterResourceAnalyzer,
	...
	private static Optional<TransformationDataUsingBufferedWriterConstructor> findTransformationDataUsingWriterResource(
			ExpressionStatement writeInvocationStatementToReplace, Expression charSequenceArgument,
			TryResourceAnalyzer bufferedWriterResourceAnalyzer,
