 ...
 *
 */
public class RunTestInvocationData {

	private final ExpressionStatement expressionStatement;
	private final TypeLiteral typeLiteralArgument;

	private RunTestInvocationData(ExpressionStatement expressionStatement,
			TypeLiteral typeLiteralArgument) {
		this.expressionStatement = expressionStatement;
		this.typeLiteralArgument = typeLiteralArgument;
	}

	static Optional<RunTestInvocationData> findRunTestInvocationStatementAnalysisResult(
		...
		if (expressionStatement != null && typeLiteralArgument != null) {
			return Optional.of(new RunTestInvocationData(expressionStatement, typeLiteralArgument));
		}
		return Optional.empty();
	}

	private static Optional<ExpressionStatement> findSurroundingExpressionStatement(MethodInvocation methodInvocation) {
	...
	private static Optional<TypeLiteral> findTypeLiteralArgument(MethodInvocation methodInvocation) {
	...
	TypeLiteral getTypeLiteralArgument() {
		return typeLiteralArgument;
	}
}
