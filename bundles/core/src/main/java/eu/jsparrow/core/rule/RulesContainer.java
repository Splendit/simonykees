...
import eu.jsparrow.core.rule.impl.ReplaceJUnit3TestCasesRule;
...
import eu.jsparrow.core.rule.impl.ShiftAssertJDescriptionsBeforeAssertionsRule;
...
public class RulesContainer {
	...
	public static List<RefactoringRule> getAllRules(boolean isStandalone) {
		...
		rules.addAll(Arrays.asList(
				...
				new ShiftAssertJDescriptionsBeforeAssertionsRule(),
