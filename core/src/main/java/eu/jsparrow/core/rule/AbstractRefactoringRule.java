 ...
 */
public abstract class AbstractRefactoringRule<T extends AbstractASTRewriteASTVisitor> implements RefactoringRule {

	private static final Logger logger = LoggerFactory.getLogger(AbstractRefactoringRule.class);
	...
	protected AbstractRefactoringRule() {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AbstractRefactoringRule<?> other = (AbstractRefactoringRule<?>) obj;
		if (id == null) {
			if (other.id != null)
				return false;
