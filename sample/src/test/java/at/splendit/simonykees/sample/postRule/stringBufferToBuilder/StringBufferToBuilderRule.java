package at.splendit.simonykees.sample.postRule.stringBufferToBuilder;
...
public class StringBufferToBuilderRule {
	...
	private void test1() {
		...
		StringBuilder localStringBuffer3, localStringBuffer4 = new StringBuilder();
	...
	private StringBuffer test4(StringBuffer stringBufferArg) {
		StringBuilder localStringBuffer1 = new StringBuilder();
		StringBuilder localStringBuffer2 = null;
		StringBuilder localStringBuffer3 = null, localStringBuffer4 = new StringBuilder();
