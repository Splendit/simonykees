package at.splendit.simonykees.sample.postRule.stringLiteralEqualityCheck;
...
public class StringLiteralEqualityCheckRule {
	...
	public boolean swapExpressionWithStringLiteralIgnoreCase(String input) {
		"StringLiteralEqualityCheckRule".equalsIgnoreCase(getClass().getName());
	...
	public boolean swapMethodInvocationExpresionIgnoreCase() {
		boolean swap = "vAlue".equalsIgnoreCase(getValue());
		return swap;
	}
