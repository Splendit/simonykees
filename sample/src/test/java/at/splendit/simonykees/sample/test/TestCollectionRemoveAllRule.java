...
public class TestCollectionRemoveAllRule extends AbstractReflectiveMethodTester {
	...
	private static Logger log = LoggerFactory.getLogger(TestCollectionRemoveAllRule.class);

	private static PreAndPostClassHolder holder;

	public TestCollectionRemoveAllRule(ParameterType parameterType, String value) {
	...
	public static void setUptHolderInstance() throws Exception {
		holder = new PreAndPostClassHolder(at.splendit.simonykees.sample.preRule.TestCollectionRemoveAllRule.class,
				at.splendit.simonykees.sample.postRule.allRules.TestCollectionRemoveAllRule.class);
	}
