...
public class TestBracketsToControlRule extends AbstractReflectiveMethodTester {
	...
	public static void setUptHolderInstance() throws Exception {
		holder = new PreAndPostClassHolder(eu.jsparrow.sample.preRule.TestBracketsToControlRule.class,
				eu.jsparrow.sample.postRule.allRules.TestBracketsToControlRule.class);
	}
