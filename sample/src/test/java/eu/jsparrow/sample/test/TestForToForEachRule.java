...
public class TestForToForEachRule extends AbstractReflectiveMethodTester {
	...
	private static Logger log = LoggerFactory.getLogger(TestForToForEachRule.class);
	...
	public static void setUptHolderInstance() throws Exception {
		holder = new PreAndPostClassHolder(eu.jsparrow.sample.preRule.TestForToForEachRule.class,
				eu.jsparrow.sample.postRule.allRules.TestForToForEachRule.class);
	}
