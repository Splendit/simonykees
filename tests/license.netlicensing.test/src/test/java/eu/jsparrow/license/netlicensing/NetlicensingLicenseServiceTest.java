...
public class NetlicensingLicenseServiceTest {
	...
	public void test_verifySecret_shouldReturnTrue() {
		String secret = "HARDWARE-INFORMATION-ID";
		NetlicensingLicenseModel licenseMode = new NetlicensingLicenseModel("key", secret, "product-nr", "module-nr", LicenseType.NODE_LOCKED);
	...
	public void test_verifySecret_shouldReturnFalse() {
		...
		NetlicensingLicenseModel licenseMode = new NetlicensingLicenseModel("key", expectedSecret, "product-nr", "module-nr", LicenseType.NODE_LOCKED);
