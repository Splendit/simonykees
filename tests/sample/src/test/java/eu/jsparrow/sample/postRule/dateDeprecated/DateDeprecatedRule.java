...
public class DateDeprecatedRule {
	...
	private Date /* name leading comment */ fieldWithComments /* name trailing comment */; // trailing comment
	{
 ...
 = calendar.getTime();
	...
	public void savingComments() {
		...
		Date /* leading name comment */ date /* trailing name comment */ = calendar.getTime() ; // trailing statement comment
