...
public class TestCollectionRemoveAllRule extends AbstractReflectiveMethodTester {
	...
	public static void setUptHolderInstance() throws Exception {
		holder = new PreAndPostClassHolder(eu.jsparrow.sample.preRule.TestCollectionRemoveAllRule.class,
				eu.jsparrow.sample.postRule.allRules.TestCollectionRemoveAllRule.class);
	}
