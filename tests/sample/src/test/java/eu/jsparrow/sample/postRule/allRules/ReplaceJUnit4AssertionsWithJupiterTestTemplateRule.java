...
public class ReplaceJUnit4AssertionsWithJupiterTestTemplateRule {
	...
	public class TestTemplateInvocationContextProviderExample implements TestTemplateInvocationContextProvider {
		...
		private TestTemplateInvocationContext createTestTemplateInvocationContext(String parameter) {
			return new TestTemplateInvocationContext() {
				...
				public String getDisplayName(int invocationIndex) {
					return new StringBuilder().append("Index of invocation: ")
						.append(1)
						.append(", parameter: ")
						.append(parameter)
						.append(";")
