...
::compareByAge);
	...
	void testValidTransformation() {
		...
		comparator = (Comparator<Integer>) Integer::compareTo;
		...
		comparators = new Comparator[] {
				...
				Comparator.comparingInt(Deque<Integer>::getFirst),
				Comparator.comparing(Deque<String>::getFirst),
				(Comparator<?>) Comparator.comparingInt(Deque<Integer>::getFirst),
				(Comparator<?>) Comparator.comparing(Deque<String>::getFirst) };


		Function<? super ArrayDeque<Integer>, Number> jokerSuperArrayDequeToInteger = Deque<Integer>::getFirst;
		Function<Deque<Integer>, Integer> DequeOfIntegerToInteger = Deque<Integer>::getFirst;

		Function<? super Deque<Integer>, Integer> jokerSuperDequeToInteger = Deque<Integer>::getFirst;
		Function<? super Deque<Integer>, Number> jokerSuperDequeToInteger2 = Deque<Integer>::getFirst;

		Function<? super Deque<Integer>, Comparable<?>> jokerSuperDequeToComparable = Deque<Integer>::getFirst;
		Function<? super ArrayDeque<Integer>, Comparable<?>> jokerSuperArrayDequeToComparable = Deque<Integer>::getFirst;
		Function<? super Deque<Integer>, ? extends Comparable<?>> jokerSuperDequeToJokerExtendsComparable = Deque<Integer>::getFirst;
		Function<? extends Deque<Integer>, Integer> jokerExtendsDequeToInteger = Deque<Integer>::getFirst;
		Function<? extends Deque<Integer>, Comparable<?>> jokerExtendsDequeToComparable = Deque<Integer>::getFirst;
		Function<? extends Deque<Integer>, ? extends Comparable<?>> jokerExtendsDequeToJokerExtendsComparable = Deque<Integer>::getFirst;
