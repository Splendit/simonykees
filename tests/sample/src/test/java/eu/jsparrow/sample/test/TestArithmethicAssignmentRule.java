...
public class TestArithmethicAssignmentRule extends AbstractReflectiveMethodTester {
	...
	private static Logger log = LoggerFactory.getLogger(TestArithmethicAssignmentRule.class);
	...
	public static void setUptHolderInstance() throws Exception {
		holder = new PreAndPostClassHolder(eu.jsparrow.sample.preRule.ArithmethicAssignmentRule.class,
				eu.jsparrow.sample.postRule.allRules.ArithmethicAssignmentRule.class);
	}
