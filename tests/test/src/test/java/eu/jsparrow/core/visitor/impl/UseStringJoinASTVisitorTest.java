...
public class UseStringJoinASTVisitorTest extends UsesSimpleJDTUnitFixture {
	...
	@Test
	public void visit_fakeCollectionStream_shouldNotTransform() throws Exception {
		fixture.addImport(java.util.stream.Stream.class.getName());

		assertNoChange(""+
				"		class FakeCollection extends java.util.ArrayList<String>{ \n" + 
				"		}\n" + 
				"		FakeCollection list = new FakeCollection();\n" + 
