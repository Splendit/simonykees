...
class StatementLambdaToExpressionASTVisitorTest extends UsesSimpleJDTUnitFixture {
	...
	@Test
	void visit_simpleExpressionLambda_shouldReplace() throws Exception {
		assertChange(//
	...
	@Test
	void visit_simpleReturnLambda_shouldReplace() throws Exception {
		assertChange(//
	...
	@Test
	void visit_tooManyStatements_shouldNotReplace() throws Exception {
		assertNoChange(String.format(blockTemplate, "{ new String(); new String(); return; }"));
	}

	@Test
	void visit_invalidStatement_shouldNotReplace() throws Exception {
		assertNoChange(String.format(blockTemplate, "{ int d = 0; }"));
	}

	@Test
	void visit_simplePredicate_shouldReplace() throws Exception {
		assertChange(//
	...
	@Test
	void visit_whenReplacementHappens_ShouldUpdateListeners() throws Exception {
