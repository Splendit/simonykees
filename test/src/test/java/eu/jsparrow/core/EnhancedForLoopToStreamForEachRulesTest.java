...
public class EnhancedForLoopToStreamForEachRulesTest extends AbstractRulesTest {
	private static final String POSTRULE_PACKAGE = RulesTestUtil.BASE_PACKAGE + ".postRule.enhancedForLoopToStreamForEach";
	...
	public EnhancedForLoopToStreamForEachRulesTest(String fileName, Path preRule, Path postRule) {
		...
		rulesList.add(new EnhancedForLoopToStreamForEachRule(EnhancedForLoopToStreamForEachASTVisitor.class));
	}
