...
public class TryWithResourceRulesTest extends AbstractRulesTest {

	private static final String POSTRULE_PACKAGE = RulesTestUtil.BASE_PACKAGE + ".postRule.tryWResource";
	...
	public TryWithResourceRulesTest(String fileName, Path preRule, Path postRule) {
		...
		rulesList.add(new TryWithResourceRule(TryWithResourceASTVisitor.class));
	}
